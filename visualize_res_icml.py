...
def visualize_regret(ax: plt.Axes, RES: dict, fontsize:int=14, n_repeat:int=15, 
    ...
    init_regret = RES["COBAR"][:,0].mean(axis=0)
...
# ras-1d-1c
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_RASTRIGIN_1D-InterP-B2.90-FB1.00-RI1--none-ci-R15-P2-T200_I1_L4-TI10-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_RASTRIGIN_1D-B2.00-FB1.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
# ackley-5D
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_ACKLEY_5D-noise_c-InterP-B0.10-FB4.00-RI1--none-ci-R15-P2-T200_I1_L4-TI5-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_ACKLEY_5D-noise_c-B0.10-FB4.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_WATER_CONVERTER_32D_NEG_3C-InterP-B20.00-FB20.00-RI1--none-ci-R15-P2-T200_I1_L4-TI5-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_WATER_CONVERTER_32D_NEG_3C-B20.00-FB20.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
# vessel 
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_VESSEL_4D_3C-InterP-B10.00-FB10.00-RI1--none-ci-R16-P2-T200_I1_L4-TI5-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_VESSEL_4D_3C-B10.00-FB10.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
# car cabin
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_CAR_CAB_7D_8C-InterP-B2.00-FB2.00-RI1--none-ci-R15-P2-T200_I1_L4-TI5-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_CAR_CAB_7D_8C-B2.00-FB2.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
# spring
RES_num = {}
RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_SPRING_3D_6C-InterP-B2.00-FB2.00-RI1--none-ci-R15-P2-T200_I1_L4-TI5-USexact.npy")
RES_num["CONFIG"] = np.load(f"{CONFIG_DIR}OL-Regret-Figure_SPRING_3D_6C-B2.00-FB2.00-RI1--none-ucb-R5-P2-T200_I1_L4-TI1-USexact.npy")
...
plt.savefig("simple_regret_icml.pdf")
# plt.show()