...
for idx, c_portion in enumerate(np.linspace(.1, .9, 5)):
    RES_num = {}
    RES_num["COBAR"] = np.load(f"{CBO_DIR}OL-Regret-Figure_RASTRIGIN_1D-CP{c_portion:.2%}_noise-InterP-B2.00-FB2.00-RI1--none-ci-R15-P2-T2500_I1_L4-TI1-USexact.npy")
    RES_num["CONFIG"] = np.load(f"{CBO_DIR}OL-Regret-Figure_RASTRIGIN_1D-CP{c_portion:.2%}_noise-B2.00-FB2.00-RI1--none-ucb-R5-P2-T2500_I1_L4-TI1-USexact.npy")
...
plt.savefig("simple_regret_scan_icml.pdf")
# plt.show()