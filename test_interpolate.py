...
def experiment(exp:str='rastrigin_1d', method:str='qei', n_repeat:int=2, train_times:int=5, n_iter:int=20, n_init:int=10, 
    ...
    if method in ['cmes-ibo', 'ts', 'qei', 'random']:
        ...
        regret = baseline_cbo_m(x_tensor, y_tensor, c_tensor_list, 
                                ...
                                plot_result=True, save_result=True, save_path=f'./res/interpolate/comparison/baseline/{method}', 
        ...
        regret = cbo_multi(x_tensor, y_tensor, c_tensor_list, 
                    ...
                    plot_result=True, save_result=True, save_path='./res/interpolate/comparison/cbo', fix_seed=True,  pretrained=False, ae_loc=None, 
        ...
        regret = baseline_scbo(x_tensor=x_tensor, y_func=y_func, c_func_list=c_func_list,
            ...
            plot_result=True, save_result=True, save_path='./res/interpolate/comparison/scbo', fix_seed=True,
...
if __name__ == "__main__":
    ...
    experiment(exp='rastrigin_1d', n_init=n_init, n_repeat=n_repeat, n_iter=n_iter, train_times=train_times, method='cbo', interpolate=interpolate)
    ...
    experiment(exp='ackley_5d', n_init=n_init2, n_repeat=n_repeat, n_iter=n_iter, method='cbo', interpolate=interpolate)
    ...
    experiment(exp='water_converter_32d_neg_3c', n_init=n_init3, n_repeat=n_repeat, n_iter=n_iter, method='cbo', interpolate=interpolate)
    ...
    experiment(exp="vessel_4D_3C", n_init=2, n_iter=200, n_repeat=n_repeat, method='cbo', interpolate=interpolate)
    ...
    #     experiment(exp="car_cab_7d_8c", n_init=5, n_iter=200, n_repeat=16, method=method)
    experiment(exp="car_cab_7d_8c", n_init=5, n_iter=200, n_repeat=n_repeat,  method='cbo', interpolate=interpolate)
    ...
    experiment(exp="spring_3d_6c", n_init=10, n_iter=200, n_repeat=n_repeat,  method='cbo', interpolate=interpolate)